...
This state will stop the changedetect service and disable it at boot time.
...
Creates the docker instance and runs the ``changedetect`` main state, ready for testing.
